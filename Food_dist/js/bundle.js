  ...
  var NewMenuItem = /*#__PURE__*/function () {
    ...
    _createClass(NewMenuItem, [{
      ...
      value: function createNewItem() {
        ...
        element.innerHTML = " <div class=\"menu__item col-lg-3\">\n                <img src= ".concat(this.newImg, " alt= ").concat(this.newAlt, ">\n                <h3 class=\"menu__item-subtitle\">").concat(this.newSubtitle, "</h3>\n                <div class=\"menu__item-descr\">").concat(this.newDesc, "</div>\n                <div class=\"menu__item-divider\"></div>\n                <div class=\"menu__item-price\">\n                    <div class=\"menu__item-cost\">\u0426\u0435\u043D\u0430:</div>\n                    <div class=\"menu__item-total\"><span>").concat(this.newPrice, "</span> \u0433\u0440\u043D/\u0434\u0435\u043D\u044C</div>\n                </div>\n            </div>");
...
function slider() {
  var slideIndex = 1,
      offset = 0;
  var offerSlides = document.querySelectorAll('.offer__slide'),
  ...
  if (offerSlides.length < 10) {
    total.textContent = "0".concat(offerSlides.length);
  ...
  next.addEventListener('click', function () {
    ...
    innerWrap.style.transform = "translateX(-".concat(offset, "px)");
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) {
  var wrapper = document.querySelector(tabsParentSelector),
...
function timer(id, deadline) {
  var clearTimer1 = document.querySelector('.timer__block #days'),
  ...
  function getTimeRemaining(endtime) {
    var now = new Date();
    var temp = Date.parse(endtime) - Date.parse(now);
    var days = Math.floor(temp / (1000 * 60 * 60 * 24)),
  ...
  console.log(deadline); // Поменять дату, до которой будет действовать скидка

  var date = document.querySelector('.promotion__descr');
...
window.addEventListener('DOMContentLoaded', function () {
  var modalTimer = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.openModal)('.modal', modalTimer);
  }, 10000);
